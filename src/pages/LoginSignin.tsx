...
export default function LoginSignup() {
  ...
  return (
    ...
    >
      ...
      <ParallaxLayer offset={1} factor={1.5} speed={0.3} className=" ">
      ...
      >
        {" "}
        <img src="/img/res1.webp" alt="resource1" width={400} className="" />
      </ParallaxLayer>
      <ParallaxLayer
        offset={0.9}
        speed={0.1}
      ...
      >
        {" "}
        <img src="/img/res2.webp" alt="resource2" width={400} className="" />
      </ParallaxLayer>
      <ParallaxLayer
        offset={0.4}
        speed={0.5}
      ...
      >
        {" "}
        <img src="/img/res3.webp" alt="resource3" width={400} className="" />
      </ParallaxLayer>
      <ParallaxLayer
        offset={0.5}
        speed={0.5}
      ...
      >
        {" "}
        <img src="/img/res4.webp" alt="resource4" width={400} className="" />
      </ParallaxLayer>
      <ParallaxLayer
        offset={0.6}
        speed={0.3}
      ...
      >
        {" "}
        <img src="/img/res5.webp" alt="resource5" width={400} className="" />
      </ParallaxLayer>
      <ParallaxLayer
        offset={0.8}
        speed={1}
